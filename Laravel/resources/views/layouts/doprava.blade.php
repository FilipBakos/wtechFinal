...
@section('content')
    ...
    {{--<form action="platbaADoprava.html" class="order-form">--}}
        <div class="wrapper-order">
            ...
            <input type="text" name="first-name" id="first-name" class="text-field" placeholder="Meno" value="{{ $user->first_name }}">
        </div>

        <div class="wrapper-order">
            <label for="second-name">Priezvisko</label>
            <input type="text" name="second-name" id="second-name" class="text-field" placeholder="Priezvisko" value="{{ $user->second_name }}">
        </div>
        ...
        <div class="wrapper-order-short">
            ...
            <input type="text" name="house-number" id="house-number" class="text-field" placeholder="Č. domu" value="{{ $user->house_number }}">
        </div>
